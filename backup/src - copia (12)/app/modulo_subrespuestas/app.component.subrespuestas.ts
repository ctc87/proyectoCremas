...
export class appComponentSubRespuestas implements OnInit {
  ...
  @Input() public IdCuestionario: number; 
  @Input() public IdCuestionarioNivel1: number; 
  @Input() public IdCuestionarioNivel2: number; 
  @Input() public IdCuestionarioNivel3: number; 
  @Input() public IdCuestionarioNivel4: number; 
