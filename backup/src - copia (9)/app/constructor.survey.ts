export class survey {
	constructor(
		...
		public idSubrespuestanivel1 : number,
		public idSubrespuestanivel2 : number,	
		public idSubrespuestanivel3 : number,
		public idSubrespuesta1 : number,
		public idSubrespuesta2 : number,
